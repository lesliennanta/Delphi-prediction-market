...
export default function Sidebar() {
  ...
  return (
    <aside className="flex flex-col gap-6">
      ...
      <div className="rounded-2xl border-2 border-accent-800 bg-accent-950 p-4">
        ...
        <button className="mt-3 w-full rounded-full bg-accent-500 py-2 text-sm font-semibold text-surface-2 transition-transform hover:-translate-y-0.5">
          New Market
        </button>
      </div>
    </aside>
